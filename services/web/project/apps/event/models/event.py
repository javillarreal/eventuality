...
event_promoters = db.Table('event_promoters',
...
class Event(db.Model):
    ...
    promoters = db.relationship('Promoter', secondary=event_promoters)
    cateogries = db.relationship('EventCategory', secondary=event_categories)
